...
export default function TasksTable({ tasks }) {
    ...
    const saveTask = (task) => {
        ...
        executeReduxAction(addTask(savedTask));
        setTaskEditable("");
    }
                ...
                <TableBody>
                    {tasks.map((task) => (
                        <TableRow key={task.name}>
                            ...
                            <TableCell align="right">{taskEditable === task.id ?
                                <TextField
                            ...
                            <TableCell align="right">{taskEditable === task.id ?
                                ...
                                />
                                : task.duration}</TableCell>
                            <TableCell align="right">

                                { taskEditable === task.id ? <IconButton> <CheckCircleIcon onClick={()=>saveTask(task)}/> </IconButton> :
                                    <IconButton aria-label="check">
                                        <EditIcon id="edit-task-icon" onClick={() => editTask(task)} />
                                    </IconButton>}
